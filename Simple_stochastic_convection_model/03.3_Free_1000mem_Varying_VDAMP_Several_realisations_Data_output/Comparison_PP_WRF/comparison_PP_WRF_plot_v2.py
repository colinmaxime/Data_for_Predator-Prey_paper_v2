...
def multi_plot_comparison_PP_WRF_Ctrl_and_Exp(time_WRF_ctrl_list, time_WRF_exp_list, time_PP_list, var_now_WRF_ctrl_list, var_now_WRF_exp_list, var_now_WRF_str_list, var_now_PP_ctrl_list, var_now_PP_exp_list, var_now_PP_str_list, var_now_str_for_title_list, time_min,time_max,ylim_min="None",ylim_max="None"):
    ...
    plt.tight_layout()
    plt.savefig('./Comparison_PP_WRF_ALL' + '_v11.eps') #bbox_inches='tight'
    plt.savefig('./Comparison_PP_WRF_ALL' + '_v11.png') #bbox_inches='tight'
...
def plot_comparison_PP_WRF_Ctrl_and_Exp(time_WRF_ctrl,time_WRF_exp,time_PP,var_now_WRF_ctrl,var_now_WRF_exp,var_now_WRF_str,var_now_PP_ctrl,var_now_PP_exp,var_now_PP_str,var_now_str_for_title,time_min,time_max,ylim_min,ylim_max):
    ...
    if ((ylim_min == "None") or (ylim_max == "None")):
        ...
        if (var_now_str_for_title == 'Humidity_macrostate'):
            ...
            ax1.set_ylim(new_WRF_axes_y_min, WRF_axes_y_max)
        elif (var_now_str_for_title == 'Humidity_microstate'):
            Dall_over_Dmin_PP = float(PP_axes_y_max - 0)/float(PP_ctrl_y_mean - 0)
            new_WRF_axes_y_max = 0 + (WRF_ctrl_y_mean - 0)*Dall_over_Dmin_PP
            ax1.set_ylim(0, new_WRF_axes_y_max)
            ax2.set_ylim(0, PP_axes_y_max)
    ...
    #ttl.set_position([.5,1.05])
    fig.tight_layout()
    plt.savefig('./Comparison_PP_WRF_' + var_now_str_for_title + '_v8.eps') #bbox_inches='tight'
    plt.savefig('./Comparison_PP_WRF_' + var_now_str_for_title + '_v8.png') #bbox_inches='tight'
    #plt.savefig('./time_series_homog_All_' + var_now_str + '_' + title_part1 + '_VDAMP_' + VDAMP_str + '_first_restart_' + first_restart_str + '_nb_mem_' + nb_mem_str + '_finish_time_' + finish_time_str + '_time_max_' + time_max_str + '_v2.png') #bbox_inches='tight'
    #plt.show()
...
qvapor_subcloud_macrostate_WRF_ctrl = ifile_WRF_ctrl.variables['QVAPOR_SUBCLOUD_LAYER_AVE_HOR_AVE_MEMBERS_AVE'][:]
qvapor_subcloud_microstate_WRF_ctrl = ifile_WRF_ctrl.variables['QVAPOR_HOR_STD_SUBCLOUD_LAYER_AVE_MEMBERS_AVE'][:]
...
qvapor_subcloud_macrostate_WRF_exp = ifile_WRF_exp.variables['QVAPOR_SUBCLOUD_LAYER_AVE_HOR_AVE_MEMBERS_AVE'][:]
qvapor_subcloud_microstate_WRF_exp = ifile_WRF_exp.variables['QVAPOR_HOR_STD_SUBCLOUD_LAYER_AVE_MEMBERS_AVE'][:]
...
plot_comparison_PP_WRF_Ctrl_and_Exp(time_hour_from_zero_WRF_ctrl, time_hour_from_zero_WRF_exp, time_index*PP_time_scaling_factor, 1000*qvapor_subcloud_macrostate_WRF_ctrl, 1000*qvapor_subcloud_macrostate_WRF_exp, 'Humidity macrostate (g/kg)', R_ctrl_ens_ave, R_ens_ave, 'R (unitless)', 'Humidity_macrostate', time_min,time_max,ylim_min="None",ylim_max="None")

print 'plot 2: microstate'
print "time_hour_from_zero_WRF_ctrl.shape ", time_hour_from_zero_WRF_ctrl.shape
print "qvapor_subcloud_microstate_WRF_ctrl.shape ", qvapor_subcloud_microstate_WRF_ctrl.shape 
plot_comparison_PP_WRF_Ctrl_and_Exp(time_hour_from_zero_WRF_ctrl, time_hour_from_zero_WRF_exp, time_index*PP_time_scaling_factor, 1000*qvapor_subcloud_microstate_WRF_ctrl, 1000*qvapor_subcloud_microstate_WRF_exp, 'Humidity microstate (g/kg)', V_ctrl_ens_ave, V_ens_ave, 'V (unitless)', 'Humidity_microstate', time_min,time_max,ylim_min="None",ylim_max="None")
...
var_now_WRF_ctrl_list = [1000*qvapor_subcloud_macrostate_WRF_ctrl, 1000*qvapor_subcloud_microstate_WRF_ctrl, 24*rain_rate_WRF_ctrl]
var_now_WRF_exp_list = [1000*qvapor_subcloud_macrostate_WRF_exp, 1000*qvapor_subcloud_microstate_WRF_exp, 24*rain_rate_WRF_exp]
var_now_WRF_str_list = ['Humidity macrostate (g/kg)', 'Humidity microstate (g/kg)', 'Precipitation (mm/day)']
...
var_now_str_for_title_list = ['Humidity_macrostate', 'Humidity_microstate', 'Precipitation']
