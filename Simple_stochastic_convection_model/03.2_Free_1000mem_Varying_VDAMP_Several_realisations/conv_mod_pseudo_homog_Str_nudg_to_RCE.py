...
PSENS = 0.1
VPSENS = 0.5
VDAMP = 0.9    #  0 = no damping (maximum memory), 1 = no persistence (no memory) / fully damped
...
Nudg_in_ctrl = False
Rforce = -100        # dummy
[R,V,P] = time_integration(R,V,P,N,Ve,Pe2,Nudg_in_ctrl,Rforce)
...
plot_time_series_simple_model(R,P,V,time_min,time_max,ylim_min,ylim_max, VDAMP, Str_nudg, V_stochastic, P_stochastic, Ctrl_run, Exp_ave, Final_plot, 0, 0, 0)
...
for mem in xrange(0, nb_mem):
    ...
    [R2,V2,P2] = time_integration(R2,V2,P2,finish_time,Ve_mem,Pe2_mem,Str_nudg,Rforce)
...
plot_time_series_simple_model(R_ens_ave,P_ens_ave,V_ens_ave,time_min,time_max,ylim_min,ylim_max, VDAMP, Str_nudg, V_stochastic, P_stochastic, Ctrl_run, Exp_ave, Final_plot, first_restart, nb_mem, finish_time)
...
for time_max in time_max_array:
    ...
    for ii, var_now in enumerate(var_to_plot_ens_ave):
        ...
        plot_time_series_simple_model_Ctrl_and_Exp(var_now,var_now_ctrl,time_min,time_max,ylim_min,ylim_max, VDAMP, Str_nudg, V_stochastic, P_stochastic, first_restart, nb_mem, finish_time, var_now_str, Method)
